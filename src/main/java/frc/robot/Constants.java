...
public final class Constants {
  ...
  public static final class RobotRecorderConstants{
    ...
    public static final String  SAVE_FILE_PATH        = "/home/lvuser/robotRecordings/";// path on the roborio to keep robotArray files( thanks for ruining the cool looking code )
